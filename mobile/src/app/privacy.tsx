...
export default function Privacy() {
  return <LegalScreen title="Privacy Policy" updated="July 14, 2026" sections={[
    ...
    { title: 'Why we use it', body: 'We use this information to provide scheduling, attendance, point-of-sale, analytics, security, support, billing, and service reliability. We do not sell personal information.' },
    { title: 'Sharing and processors', body: 'Information may be handled by service providers used for hosting, storage, email, error monitoring, push notifications, AI features, and payments. Payment card details are processed by Stripe and are not stored by Shiftora.' },
